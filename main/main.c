...
// --- Seus dados ---
#define NOME_ALUNO "Mike Silva de Almeida"
#define RM_ALUNO "87413"
// ------------------
...
void app_main(void) {
    printf("{Mike Silva de Almeida-RM:87413} [SISTEMA] Iniciando CP2 - Sistema de Dados Robusto.\n");
    xFilaDeDados = xQueueCreate(TAMANHO_FILA, sizeof(int));
    if (xFilaDeDados == NULL) {
        printf("{Mike Silva de Almeida-RM:87413} [SISTEMA] Falha ao criar a fila.\n");
        return;
    }
    ...
    printf("{Mike Silva de Almeida-RM:87413} [SISTEMA] Inicializacao concluida. WDT ja ativo.\n");
